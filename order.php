...
$pro_code = 0;
if (isset($_GET['id']))
    $pro_code = $_GET['id'];//دریافت کد کالای سفارش داده شده

if (!(isset($_SESSION["state_login"]) && $_SESSION["state_login"] === true)) {//فقط کاربری که وارد سایت شده اجازه سفارش دارد
?>
<br />
...
//پرس و جوی  مشخصات محصول انتخابی
...
?> 
  ...
  <br />
<!-- اطلاعات محصول انتخابی در فرم نمایش داده می شود-->
    ...
    <tr>
       ...
       <!--پس از نوشتن تعداد سفارش و ترک این جعبه متن متد محاسبه مبلغ کل فراخوانی می شود -->
   ...
   function calc_price()
    {
      ...
      var total_price;
      <!-- در صورتی که تعداد کالای سفارش داده شده بیشتر از موجودی کل باشد سیستم با صفر کردن تعداد سفارش اجازه ثبت سفارش را نخواهد داد-->
      if (count>pro_qty){
       ...
       if (count==0 || count=='')
        ...
        <!-- قرار دادن مبلغ قابل پرداخت در جعبه متن مربوطه -->
...
<!-- بررسی صحت ورود اطلاعات در رویداد کلیک دکمه خرید محصول-->
<script type="text/javascript">
<!--
...
<!-- نمایش اطلاعات محصول سفارش داده شده-->
<table>
 <tr>
